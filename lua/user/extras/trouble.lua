...
function M.config()
  ...
  wk.register({
    ...
    ["<leader>n"] = {function() require("trouble").next({skip_groups = true, jump = true}) end, 'Next trouble'},
    ["<leader>p"] = {function() require("trouble").previous({skip_groups = true, jump = true}) end, 'Previous trouble'},
  })
end
